...
const {createJob, getJob, getAllJobs, getAllJobEvents, createBulkJobs } = require('../controllers/job.controller');
...
router.route('/bulk').post(authMiddleware, createBulkJobs);
